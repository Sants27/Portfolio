...
import myCV from "../assets/CV/Ignatius_Varrel_Santoso_CV.pdf";
import {
  AiOutlineGithub,
  AiOutlineInstagram,
  AiOutlineLinkedin,
            ...
            <div className="w-[1200px] mx-auto relative">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 xs:gap-12 sm:gap-6 md:gap-8 lg:gap-10">
                    ...
                    >
                        ...
                        <motion.h1 
                            className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            <motion.a
                                href={myCV}
                                download="Ignatius_Varrel_Santoso_CV.pdf"
                                initial={{ backgroundColor: "transparent", color: "#f1f5f9", borderColor: "#C084FC" }}
                                whileHover={buttonHover}
                                className="z-10 cursor-pointer font-bold text-slate-100 md:w-auto px-3 sm:px-4 py-1.5 sm:py-2 border border-purple-400 rounded-xl lg:text-base text-xs xs:text-sm"
                                >
                                Download CV
                            </motion.a>

                            
                            <div className="flex flex-row items-center gap-6 xs:gap-3 md:gap-4 text-4xl md:text-6xl text-slate-100 z-20">
                                <motion.a 
                                    href={github}
                                ...
                                >
                                    <AiOutlineGithub className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10" />
                                </motion.a>
                                <motion.a
                                    href={linkedin}
                                    whileHover={iconHover}
                                    ...
                                    rel="noopener noreferrer"
                                >
                                    <AiOutlineLinkedin className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10" />
                                </motion.a>
                                <motion.a
                                    href={instagram}
                                    whileHover={iconHover}
                                    ...
                                    rel="noopener noreferrer"
                                >
                                    <AiOutlineInstagram className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10" />
                                </motion.a>
                            </div>
                        </motion.div>
                    </motion.div>
