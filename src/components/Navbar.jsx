    ...
    return (
        <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
            <div className="max-w-[1300px] mx-auto bg-green-200 flex justify-between text-gray-200 text-xl items-center px-12 h-20">
                <a href='#' className='text-black'>Ignatius Varrel Santoso</a>

                <ul className='hidden md:flex gap-12 z-10 cursor-pointer text-black'>
                    <li>
                ...
                <div onClick={toggleNav} className='md:hidden z-50 text-black'>
                ...
                <motion.div
                    ...
                    className='fixed left-0 top-0 w-full min-h-screen bg-gray-700 z-40'
                >
